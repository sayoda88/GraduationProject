...
export class DoctorAppointmentComponent implements OnInit  {
  ...
  observerForAppDoc={
    next:(data:any)=>{
      if(data.message=='Done'){
        ...
        this.appDocData=data.appointmentSlot;
        this.IsWait=false
  ...
  observerForBook={
    ...
    error:(err:any)=>{this.errRespon=err.error ;;console.log(this.errBookRespon)}
  }
  constructor(private _MatDialog:MatDialog,private _ActivatedRoute:ActivatedRoute,private fb:FormBuilder,private _UserService:UserService,private _snackBar: MatSnackBar){
  ...
  book(sID:any){
     this._UserService.bookAppoint(sID,this.docID).subscribe(this.observerForBook);
 }
  openSnackBar() {
