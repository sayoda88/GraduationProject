...
export class NavBarComponent implements OnInit {
  ...
  constructor(public _AuthService: AuthService, private _Router: Router,
    public _UserService: UserService, private _DoctorService: DoctorService,private _snackBar: MatSnackBar) {
  ...
  /* Start Patient-side*/
  observerForSearch={
    next:(data:any)=> {this.searchResult = data.doctors},
    error:(err:any)=>{this.searchErr=err}
  };
  ...
  getProfileDoc() {
    ...
    return this._DoctorService.getProfileDoc().subscribe(this.observerForProfileDoc);}
    else {
